...
## {auto-animate=true auto-animate-easing="ease-in-out"}{background-color="#CAFFEF"} 

::: {.r-hstack}
::: {data-id="box1" auto-animate-delay="0.1" style="background: #2780e3; width: 400px; height: 150px; margin: 10px;"}
Déploiment de la page web 
:::

::: {data-id="box2" auto-animate-delay="0.1" style="background: #3fb618; width: 200px; height: 150px; margin: 10px;"}
Structures de la page (.yml .css)
:::
...
::: {data-id="box4" auto-animate-delay="0.2" style="background: #461200; width: 200px; height: 150px; margin: 10px;"}
Interprétation 
:::
...
::: {.r-stack}
::: {data-id="box1" style="background: #2780e3; width: 350px; height: 350px; border-radius: 800px; opacity: 0.3;"}
Déploiment de la page web 
:::
...
::: {data-id="box4" style="background: #461200; width: 150px; height: 100px; border-radius: 200px; opacity: 0.7;"}
Interprétation 
:::
