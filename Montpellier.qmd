...
Données récentes sur la pollition NOX à Montpellier
```{python}
...
Données mensuelles sur la pollition NOX à Montpellier
```{python}
# Show NOX Pollution Values of the last months
df_m=dp.data_prep(time='m')
viz.visualize_df(df=df_m, city='MONTPELLIER', nom_poll="NOX")
